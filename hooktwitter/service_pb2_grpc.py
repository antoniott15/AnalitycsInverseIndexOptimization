...
class DataEngineStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GiveData = channel.unary_unary(
                '/DataEngine/GiveData',
...
class DataEngineServicer(object):
    ...
    def GiveData(self, request, context):
        """Missing associated documentation comment in .proto file"""
...
def add_DataEngineServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GiveData': grpc.unary_unary_rpc_method_handler(
                    servicer.GiveData,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'DataEngine', rpc_method_handlers)
...
class DataEngine(object):
    ...
    def GiveData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/DataEngine/GiveData',
